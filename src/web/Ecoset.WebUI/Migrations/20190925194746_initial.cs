        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    AgreedToCommunication = table.Column<bool>(nullable: false),
                    EmailOnJobCompletion = table.Column<bool>(nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PurchasedById = table.Column<string>(nullable: true),
                    ...
                    SettlementCurrency = table.Column<string>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Purchases", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Purchases_AspNetUsers_PurchasedById",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    Credits = table.Column<int>(nullable: false),
                    TotalCostIncludingVat = table.Column<decimal>(nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TextValues = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserIdOfPurchaser = table.Column<string>(nullable: true),
                    CreditsSpent = table.Column<int>(nullable: false),
                    JobProcessorReference = table.Column<string>(nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProActivation", x => x.Id);
                    table.ForeignKey(
                        name: "FK_ProActivation_Jobs_JobId",
                        column: x => x.JobId,
                        principalTable: "Jobs",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProActivation_JobId",
                table: "ProActivation",
                column: "JobId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_Purchases_PurchasedById",
                table: "Purchases",
