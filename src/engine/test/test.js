...
describe("api", function () {
    ...
    describe("manager", function () {
        ...
        fs.emptyDirSync("test_output");

        // load in manager here:
        ...
        describe("Querying a nonexistent job", function () {
            it("should respond with NONEXISTENT", function () {
                manager.pollJob("nonexistent", function (err, state) {
                    if (err) {
                        assert.fail();
                    } else {
                        assert.equal(state, "NONEXISTENT");
                    }
                });
            });
        });
        ...
        var jobId = "";
        describe("Submitting a job", function () {
            it("should not return an error", function () {
                manager.submitJob(job, function (err, data) {
                    if (err) {
                        assert.fail();
                    } else {
                        jobId = data;
